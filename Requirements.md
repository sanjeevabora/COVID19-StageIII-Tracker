...
COVID19 Technology Platform
 ...
 Introduction: The idea is to build an app where we collect data from the individuals regarding their symptoms, travel history and use this data to sort them into different risk categories (Red, Orange, Yellow and Green). This data will be used to caution users and provide information regarding areas that are high risk to visit and to calculate the number of touch points they have.  
